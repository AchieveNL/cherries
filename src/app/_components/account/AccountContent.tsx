...
const TAB_VALUES = ['overview', 'profile', 'addresses', 'orders', 'store-credit', 'preferences'] as const;
...
function AccountContent() {
  ...
  const getInitialTab = (): TabType => {
    ...
    return (TAB_VALUES as readonly string[]).includes(tab || '') ? (tab as TabType) : 'overview';
  };
